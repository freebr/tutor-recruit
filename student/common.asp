...
Function checkIfProfileFilledIn()
	...
	Connect conn
	sql="SELECT BIRTHDAY,Native_City,Self_Tel,Before_Unit,EMAIL,DUTY,THESIS_TOPIC,PERSONAL_RESUME,EXPERIENCES FROM STUDENT_INFO WHERE STU_ID="&Session("Stuid")
...
If stuclient.SystemStatus=SYS_STATUS_CLOSED Then
...
Dim stu_type,opr,bOpen,startdate,enddate
