...
CKFinder.lang['fr'] =
{
	...
	common :
	{
		...
		confirmCancel	: 'Certaines options ont été modifiées. êtes vous s?r de vouloir fermer cette fenêtre?',
		ok				: 'OK',
		cancel			: 'Annuler',
	...
	FolderDelete	: 'êtes-vous s?r de vouloir effacer le dossier "%1"?',
	...
	FileRenameExt	: 'êtes-vous s?r de vouloir changer l\'extension de ce fichier? Le fichier pourrait devenir inutilisable.',
	FileRenaming	: 'Renommage en cours...',
	FileDelete		: 'êtes-vous s?r de vouloir effacer le fichier "%1"?',
	...
	BasketTruncateConfirm : 'êtes vous s?r de vouloir supprimer tous les fichiers de la corbeille?',
	BasketRemoveConfirm	: 'êtes vous s?r de vouloir supprimer le fichier "%1" de la corbeille?',
	...
	116 : 'Ce dossier n\'existe pas. Veuillez rafra?chir la page et réessayer.',
	117 : 'Ce fichier n\'existe pas. Veuillez rafra?chir la page et réessayer.',
