			...
			/** @lends CKEDITOR.ui.dialog.file.prototype */
			{
				...
				reset : function()
				{
					...
					function generateFormField()
					{
						...
						frameDocument.$.write( [ '<html dir="' + langDir + '" lang="' + langCode + '"><head><meta name="theme-color" content="#2D79B2" />
<title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">',
