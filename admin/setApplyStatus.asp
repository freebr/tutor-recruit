...
Case 4	' 已退回
	For i=0 To UBound(arrSelTurn)
		...
		turn_num=arr(1)
		' 更新填报信息
		sql=sql&"UPDATE TUTOR_STUDENT_APPLY_INFO SET APPLY_STATUS=4,TUTOR_REPLY_TIME="&toSqlString(Now)&",TUTOR_REPLY='名额限制' WHERE STU_ID="&stu_id&" AND TURN_NUM="&turn_num&";"
		' 更新学生表信息
